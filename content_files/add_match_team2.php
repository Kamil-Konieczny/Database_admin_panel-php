...
<div class="add_form" >
    ...
    echo '<label id = "idmatch"style="float:right;">'.$id_match.'</label>';
    echo '<label style="float:right;">Id meczu: </label>';

    ?>
    <form action="/panel_admina/logic_file/add_player_points_logic2.php" method="post">
        <table id="myTable" name ="myTable">
            ...
            $sql = "SELECT * FROM dbo.playerstatistics WHERE IdMatch = ? AND id > ?";
            $id = $_SESSION['last_stat'];
            $params2 = array($id_match,$id);
        ...
        <div class ="add_player_points">
            ...
            <input type="submit"  onclick="myFunction()" value = "Dodaj punkty gracza">

        </div>
    </form>

    <form action="/panel_admina/logic_file/add_match_team1_logic.php" method="post" >
        <input type="submit" style="width: 57%; position: fixed; top: 75%;" value = "Zapisz" onclick="send()">
</div>
</form>
